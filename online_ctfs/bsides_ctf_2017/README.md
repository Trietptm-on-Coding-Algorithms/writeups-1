...
The purpose of this directory and its sub-directories is to contain any information regarding challenges that we as a Cyber Team solved while participating in the online competition [BSides CTF 2017].
...
> Official URL: https://bsidessf.com/ctf.html
...
This [CTF] had a good mix of hard challenges and easy challenges. I didn't solve as much as I really wanted to, mainly due to time I had available to dedicate to it -- but it was really fun. 


Challenges
----------

The following is a list of challenges that we successfully completed as part of the [BSides CTF 2017] competition.

__Note that bolded items have a solution added; regular entries _do not_.__

* [__easyshell__](easyshell/)
...
[Bsides CTF 2017]: https://bsidessf.com/ctf.html